...
export const AUDIO_CONFIG = {
  SUPPORTED_FORMATS: ['audio/wav', 'audio/mp3', 'audio/m4a', 'audio/ogg', 'audio/webm'] as const,
...
export const DEFAULT_SETTINGS = {
  ...
  // Provider defaults — WhisperX (local) out of the box
  providerType: 'whisperx' as const,
  providerBaseUrl: 'http://localhost:8000',
  providerApiKey: '',
  providerModel: 'large-v3',
};
...
export const ERROR_MESSAGES = {
  ...
  TRANSCRIPTION_FAILED: 'Transcription failed. Please check your provider settings and try again.',
  FILE_TOO_LARGE: 'File is too large. Maximum size is 25MB.',
  UNSUPPORTED_FORMAT: 'Unsupported audio format. Please use WAV, MP3, M4A, OGG, or WebM.',
  PROVIDER_NOT_CONFIGURED: 'Transcription provider not configured. Go to Settings to set up a provider.',
} as const;
